...
<body>
                ...
                <div class="flex items-center lg:order-2">
                    <?php if (isset($_SESSION['user_info'])): ?>
                        ...
                        <a href="<?php echo UrlAction::action('admin', 'auth', 'logout'); ?>"
                            class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Đăng
                            xuất
                        </a>
                    <?php else: ?>
                        <a href="<?php echo UrlAction::action('admin', 'auth', 'login'); ?>"
                            class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Đăng
                            nhập
                        </a>
                    <?php endif; ?>
    ...
    <!-- Main Content -->
    <main class="px-[8rem] desktop:px-[18rem] py-12 space-y-8">
        <?php echo $content; ?>
    </main>
