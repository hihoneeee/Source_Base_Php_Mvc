...
<div class="bg-gray-800 shadow-md rounded-lg overflow-hidden mt-10">
    ...
    <form
        action="<?php echo isset($user) ? UrlAction::action('admin', 'user', 'update', [$user->id]) : UrlAction::action('admin', 'user', 'store'); ?>"
        ...
        <div>
            <label class="block text-white font-medium mb-2" for="role">Vai trò</label>
        ...
        <div class="flex justify-end space-x-2">
            ...
            <a href="<?php echo UrlAction::action('admin', 'user', 'index'); ?>"
                class="bg-gray-500 text-white font-semibold px-4 py-2 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400">Hủy</a>
        </div>
    </form>
</div>